...
- ~~접근성 대응을 토큰 레벨에 넣은 것은 Cloudscape뿐~~ → **정정 (2026-08-18)** —
  최소 17개 시스템이 각기 다른 층에서 처리하고 방식이 9개 층으로 갈립니다.
...
### reduced-motion — Cloudscape뿐이 아니라 9개 층입니다
...
> **17개 시스템이 처리하고, 방식이 9개 층으로 갈립니다.** (2026-08-23에 위 표에서
> 직접 셌습니다. 행이 늘어난 뒤로도 "최소 13개 · 6개 층"이 그대로 남아 있었습니다.)
