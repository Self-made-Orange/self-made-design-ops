...
description: >-
  ...
  corpus (profile=web, density=compact). The values are a starting
...
---
<!-- lang-links -->
> **English** · [한국어](web-compact.DESIGN.ko.md)
<!-- /lang-links -->

## Overview

The visual identity of web-compact. This file is a scaffold generated from the **design-systems (self-made-design-ops)**
corpus, so it is finished only once the brand-specific decisions (colour, typeface, tone)
are filled in.

- Profile: **desktop web** · density: **compact**
...
Based on a **14px** body — the dense camp (admin screens, enterprise), where 17 of the samples sit.
...
| a 14px body | **M** | `patterns/typography.md` — the dense camp, 17 samples (the largest) |
