...
description: >-
  ...
  (profile=touch, density=comfortable). 값은 표본 분포의 출발점이며 규범이 아닙니다.
colors:
...
---
<!-- lang-links -->
> [English](touch-mobile.DESIGN.md) · **한국어**
<!-- /lang-links -->

## Overview

touch-mobile의 시각 정체성. 이 파일은 **design-systems (self-made-design-ops)** 코퍼스에서 생성한 스캐폴드이므로,
브랜드 고유 결정(색·서체·톤)을 채워 넣어야 완성됩니다.

- 프로필: **터치 환경** · 밀도: **comfortable**
...
| 버튼·입력 48px | **M** | `patterns/button.md` — Material 48dp ∩ Apple 48pt |
