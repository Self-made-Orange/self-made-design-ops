...
description: >-
  ...
  corpus (profile=touch, density=comfortable). The values are a starting
...
---
<!-- lang-links -->
> **English** · [한국어](touch-mobile.DESIGN.ko.md)
<!-- /lang-links -->

## Overview

The visual identity of touch-mobile. This file is a scaffold generated from the **design-systems (self-made-design-ops)**
corpus, so it is finished only once the brand-specific decisions (colour, typeface, tone)
are filled in.

- Profile: **touch** · density: **comfortable**
...
| component | basis |
|---|---|
| button height | **48px** (touch — where Material's 48dp and Apple's 48pt meet) |
...
- If you have button size steps, start with **four**, and an even 8px increment is the easiest
  to manage
- Keep the top touch step at 48 or above
...
| buttons and inputs at 48px | **M** | `patterns/button.md` — Material 48dp ∩ Apple 48pt |
