...
description: >-
  ...
  (profile=web, density=compact). 값은 표본 분포의 출발점이며 규범이 아닙니다.
colors:
...
---
<!-- lang-links -->
> [English](web-compact.DESIGN.md) · **한국어**
<!-- /lang-links -->

## Overview

web-compact의 시각 정체성. 이 파일은 **design-systems (self-made-design-ops)** 코퍼스에서 생성한 스캐폴드이므로,
브랜드 고유 결정(색·서체·톤)을 채워 넣어야 완성됩니다.

- 프로필: **웹 데스크톱** · 밀도: **compact**
...
본문 **14px** 기준입니다 — 밀도형(관리 화면·엔터프라이즈) 진영으로, 표본 17개가 여기 속합니다.
...
| 본문 14px | **M** | `patterns/typography.md` — 밀도형 17표본 진영(최대) |
