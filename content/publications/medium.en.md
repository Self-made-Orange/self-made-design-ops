...
The collection has limits. It leans toward web, coverage differs by system, and values reflect the versions recorded in the documents. The total of 117 systems is not the sample count for every comparison. Unconfirmed information stays marked, so neither you nor your assistant should treat it as settled.
